...
import { formatName, abbreviateName, abbreviateBusinessName, hasFamilyNameGivenNameOrdering } from '@shopify/name';
...
import { RTL_LANGUAGES, dateStyle, DateStyle, WEEK_START_DAYS, DEFAULT_WEEK_START_DAY, UnicodeCharacterSet, CurrencyShortFormException } from './constants/index.esnext';
...
class I18n {
  ...
  hasEasternNameOrderFormatter() {
    return hasFamilyNameGivenNameOrdering(this.locale);
  }
