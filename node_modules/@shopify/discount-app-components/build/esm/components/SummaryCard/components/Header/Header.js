...
import { BlockStack, InlineStack, Text, List, Badge } from '@shopify/polaris';
...
function Header(props) {
  ...
  return /*#__PURE__*/React.createElement(BlockStack, {
    gap: "400"
  }, trimmedDescriptor ? /*#__PURE__*/React.createElement(InlineStack, {
    align: "space-between"
    ...
    fontWeight: "semibold",
    tone: "subdued"
  }, i18n.translate(`emptyState.${discountMethod}`, I18N_SCOPE)), /*#__PURE__*/React.createElement(BlockStack, {
    gap: "200"
  }, /*#__PURE__*/React.createElement(Text, {
    variant: "headingSm",
    as: "h3"
