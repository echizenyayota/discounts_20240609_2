...
import { BlockStack, Text, List, Link } from '@shopify/polaris';
...
function Performance({
  ...
  return /*#__PURE__*/React.createElement(BlockStack, {
    ...
    variant: "headingSm",
    as: "h3"
  }, i18n.translate('title', I18N_SCOPE)), status === DiscountStatus.Scheduled && /*#__PURE__*/React.createElement(Text, {
    as: "span",
    tone: "subdued"
  ...
  }))), hasReports && discountMethod === DiscountMethod.Code && /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement(Link, {
