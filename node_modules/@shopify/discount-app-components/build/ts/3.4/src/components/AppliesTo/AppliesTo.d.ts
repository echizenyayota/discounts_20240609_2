...
import { Field, ProductOrCollectionResource } from '../../types';
...
export declare function AppliesTo({ eligibility, selectedItems, productSelector, collectionSelector, }: AppliesToProps): React.JSX.Element;
