...
export declare function FilterPill({ unsavedChanges, filterKey, label, filter, disabled, hideClearButton, selected, initialActive, closeOnChildOverlayClick, onRemove, onClick, }: FilterPillProps): React.JSX.Element | null;
